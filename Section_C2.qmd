...
For the first discriminant function ($LD_1$), $y_1$ (age) and $y_3$ (average diastolic BP) are the most important for separating the groups, followed by $y_4$ (cholesterol) and $y_2$ (body weight):  $y_1 \rightarrow y_3 \rightarrow y_4 \rightarrow y_2$.
